...
update tb_marca set nome="Fatal Surf", ativo=true where id=2;#atualiza dados da tabela onde o id é igual a 2

delete from tb_marca where id=3; #deleta a marca onde o valor do codigo é igual a 3


INSERT INTO tb_marca (nome, ativo) VALUES ("Nike", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("H&M", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Zara", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Louis Vuitton", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Adidas", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Uniqlo", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Hermès", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Rolex", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Gucci", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Cartier", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Polo", true);
INSERT INTO tb_marca (nome, ativo) VALUES ("Armany", true);


select * from tb_marca;

select * from tb_marca where nome like "%Ni%"; #busca toda palavra que contem ni 
...
insert into tb_produtos(nome,preco,marca_id) values ("Camisa",23.99,1);
insert into tb_produtos(nome,preco,marca_id) values ("Tenis",69.99,1);
...
select * from tb_produtos where nome like "%ca%"; #mostra os produtos que contem ca
select * from tb_produtos where preco > 60;   #mostra os produtos com valor maior que 60
